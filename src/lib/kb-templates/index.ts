...
export const BUSINESS_SPHERES = [
  ...
  { id: 'beauty', icon: '💅', nameKey: 'businessSphereBeauty' },
  { id: 'restaurant', icon: '🍽️', nameKey: 'businessSphereRestaurant' },
  { id: 'fashion', icon: '👗', nameKey: 'businessSphereFashion' },
  { id: 'other', icon: '💼', nameKey: 'businessSphereOther' },
