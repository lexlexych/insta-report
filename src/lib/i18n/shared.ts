...
export const dictionary: Dictionary = {
  ru: {
    ...
    igWizardInviteAlreadyDone: 'Я уже принял(а) приглашение',
    igWizardStep1Label: 'Приглашение',
    igWizardStep2Label: 'Подключение',
  ...
  de: {
    ...
    igWizardInviteAlreadyDone: 'Ich habe die Einladung bereits angenommen',
    igWizardStep1Label: 'Einladung',
    igWizardStep2Label: 'Verbindung',
