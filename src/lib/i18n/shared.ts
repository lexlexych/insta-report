...
export const dictionary: Dictionary = {
  ru: {
    ...
    zernioConnectTitle: 'Подключить Instagram',
    ...
    zernioDisconnectConfirm: 'Отключить Instagram',
    ...
    zernioBrowserOpening: 'Открываем Instagram в браузере…',
    zernioBrowserError: 'Не удалось открыть Instagram. Закройте это окно и повторите подключение в Telegram.',
    zernioOpenBrowserButton: 'Открыть Instagram в браузере',
    ...
    onboardingFinishIncomingIntro: 'Подключите Instagram кнопкой ниже. Когда клиент напишет в Instagram Direct, в этот Telegram-чат придёт карточка с черновиком ответа. Отправить его можно одним нажатием.',
  ...
  de: {
    ...
    zernioConnectTitle: 'Instagram verbinden',
    ...
    zernioDisconnectConfirm: 'Das verbundene Instagram-Konto trennen?',
    ...
    zernioBrowserOpening: 'Instagram wird im Browser geöffnet…',
    zernioBrowserError: 'Instagram konnte nicht geöffnet werden. Schließe dieses Fenster und versuche es erneut in Telegram.',
    zernioOpenBrowserButton: 'Instagram im Browser öffnen',
    ...
    onboardingFinishIncomingIntro: 'Verbinde Instagram unten. Wenn ein Kunde in Instagram Direct schreibt, kommt eine Karte mit dem Antwortentwurf in diesen Telegram-Chat. Du kannst ihn mit einem Tippen senden.',
