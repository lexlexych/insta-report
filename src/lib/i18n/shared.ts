...
export const dictionary: Dictionary = {
  ru: {
    ...
    onboardingFinishSimulator: 'Тест-чат: проверьте базу знаний как клиент и посмотрите черновики ответов.',
    onboardingFinishIncoming: 'Входящие из Instagram: черновики ответов придут в этот Telegram-чат.',
    onboardingFinishLabels: 'Категории: настройте правила ответа для разных обращений.',
    onboardingFinishSettings: 'Настройки: базу знаний и стиль ответов можно менять в любой момент.',
    onboardingFinishDashboard: 'Дашборд: здесь видны статистика и статус подключения Instagram.',
    onboardingNext: 'Далее',
    onboardingBack: 'Назад',
    onboardingComplete: 'Завершить',
    onboardingStartWork: 'Начать работу',
  ...
  de: {
    ...
    onboardingFinishSimulator: 'Testchat: Prüfe die Wissensbasis als Kunde und sieh dir Antwortentwürfe an.',
    onboardingFinishIncoming: 'Instagram-Eingänge: Antwortentwürfe kommen in diesen Telegram-Chat.',
    onboardingFinishLabels: 'Kategorien: Lege Antwortregeln für verschiedene Anfragen fest.',
    onboardingFinishSettings: 'Einstellungen: Wissensbasis und Antwortstil kannst du jederzeit ändern.',
    onboardingFinishDashboard: 'Dashboard: Hier siehst du Statistik und Instagram-Verbindungsstatus.',
    onboardingNext: 'Weiter',
    onboardingBack: 'Zurück',
    onboardingComplete: 'Abschließen',
    onboardingStartWork: 'Loslegen',
