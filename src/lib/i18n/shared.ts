...
export const dictionary: Dictionary = {
  ru: {
    ...
    igGateTitle: 'Настройки Instagram',
    igGateHint: 'Сейчас откроется мобильная версия Instagram в отдельном окне. Если окно не открылось — нажмите кнопку ниже.',
    igGateOpen: 'Открыть Instagram',
    igGateReturn: 'После принятия приглашения закройте эти окна и вернитесь в Telegram.',
    igGateFallback: 'Открыть обычной ссылкой',
    igLoading: 'Загрузка…',
  ...
  de: {
    ...
    igGateTitle: 'Instagram-Einstellungen',
    igGateHint: 'Gleich öffnet sich die mobile Instagram-Version in einem separaten Fenster. Falls sich das Fenster nicht öffnet — tippe auf die Schaltfläche unten.',
    igGateOpen: 'Instagram öffnen',
    igGateReturn: 'Schließe nach dem Annehmen der Einladung diese Fenster und kehre zu Telegram zurück.',
    igGateFallback: 'Als normalen Link öffnen',
