...
export const dictionary: Dictionary = {
  ru: {
    ...
    igWizardInviteReturn: 'Вернитесь в мини-приложение стрелкой «Назад» вверху и нажмите «Далее».',
    ...
    igWizardOauthTitle: 'Подключите Instagram',
  ...
  de: {
    ...
    igWizardOauthTitle: 'Instagram verbinden',
